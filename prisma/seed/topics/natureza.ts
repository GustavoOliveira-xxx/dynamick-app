...
export const NATUREZA_TOPICS: SeedTopic[] = [
  {
    ...
    questions: [
      {
        ...
        explanation: {
          summary: 'A resposta é B. Produtores → primários → secundários são duas etapas de 10%: 15.000 × 0,1 × 0,1 = 150.',
      ...
      },
      {
        ...
        explanation: {
          summary: 'A resposta é A. Excesso de nutrientes → algas → morte das algas → decomposição → queda do oxigênio → mortandade.',
      ...
      },
      {
        ...
        explanation: {
          summary: 'A resposta é A. Concentração crescente a cada nível trófico é a definição de biomagnificação.',
      ...
      },
      {
        ...
        explanation: {
          summary: 'A resposta é C. Energia flui; matéria cicla. As duas afirmações são complementares, não concorrentes.',
      ...
      },
      {
        ...
        explanation: {
          summary: 'A resposta é A. Cobrir o solo não é o mesmo que restaurar um ecossistema.',
      ...
      },
      {
        ...
        explanation: { summary: 'A resposta é A. Produtores são a porta de entrada da energia no ecossistema.' },
      },
      {
        slug: 'q-eco-rec-2',
        stem:
        ...
        explanation: {
          summary: 'A resposta é A. O efeito se propaga em cascata pela cadeia, começando pelo aumento das presas.',
        },
      },
    ],
  },
    ...
    questions: [
      {
        ...
        explanation: {
          summary: 'A resposta é A. Energia = potência (kW) × tempo (h) × dias = 1,2 × 0,5 × 30 = 18 kWh.',
      ...
      },
      {
        ...
        explanation: {
          summary: 'A resposta é A. Economia = diferença de potência × número de lâmpadas × horas × dias.',
      ...
      },
      {
        ...
        explanation: {
          summary: 'A resposta é A. Eficiência de 38%: os 62% restantes se conservam, mas dispersos como calor.',
      ...
      },
      {
        ...
        explanation: {
          summary: 'A resposta é A. Consumo é potência **vezes tempo** — o tempo costuma pesar mais que a potência.',
      ...
      },
      {
        ...
        explanation: {
          summary: 'A resposta é A. Reconhece o ganho real e os dois desafios concretos, sem idealizar nem rejeitar a fonte.',
      ...
      },
      {
        ...
        explanation: { summary: 'A resposta é A. A incandescente é, na prática, um aquecedor que também ilumina.' },
      },
      {
        slug: 'q-ene-rec-2',
        stem:
        ...
        explanation: { summary: 'A resposta é A. 0,8 × 3 × 30 = 72 kWh.' },
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        explanation: {
          summary: 'A resposta é B. Só a ferrugem forma substância nova.',
      ...
      },
      {
        ...
        explanation: {
          summary: 'A resposta é A. Em sistema aberto, incorporar gás aumenta a massa; liberar gás a diminui.',
      ...
      },
      {
        ...
        explanation: {
          summary: 'A resposta é A. Coeficientes indicam proporção em mol entre as substâncias.',
      ...
      },
      {
        ...
        explanation: {
          summary: 'A resposta é B. O O₂ é o limitante: 2 mol de O₂ → 4 mol de H₂O, sobrando 2 mol de H₂.',
      ...
      },
      {
        ...
        explanation: {
          summary: 'A resposta é A. A química funciona; o monitoramento por um único parâmetro é que é insuficiente.',
      ...
      },
      {
        ...
        explanation: { summary: 'A resposta é A. Precipitado é substância nova — evidência de reação química.' },
      },
      {
        slug: 'q-qui-rec-2',
        stem:
        ...
        explanation: {
          summary: 'A resposta é A. Sistema fechado: nada entra, nada sai, massa constante.',
        },
      },
    ],
  },
