...
export const MATEMATICA_TOPICS: SeedTopic[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        explanation: {
          ...
          detailed: 'A alternativa E é a mais perigosa: acerta a conta e erra a leitura. 0,56 é quanto você **paga**; o desconto é o que **sobra do 1**.',
    ...
    questions: [
      ...
      },
      {
        ...
        explanation: {
          ...
          detailed: 'A alternativa C mostra por que o número sozinho não basta: quem tem taxa fixa menor ganha nas distâncias curtas; quem tem custo por km menor ganha nas longas.',
